            ...
            else
            {
                ...
                for($i=0; $i<$rows; $i++)
                {
                    ...
                    if($isbn != NULL)
                    {
                        ...
                        // Fetch the due date and format it
                        ...
                        $query->execute();
                        $due_date_result = mysqli_fetch_array($query->get_result());
                        if ($due_date_result) {
                ...
                for($i=0; $i<$rows; $i++)
                    if(isset($_POST['cb_book'.$i]))
                    {
                        ...
                        if(!$query->execute())
                            ...
                            if ($days > 0) {
                                echo '<script>
                                        document.getElementById("error").innerHTML += "A penalty of Rs. ' . (5 * $days) . ' was charged for keeping book ' . $_POST['cb_book' . $i] . ' for ' . $days . ' days after the due date.<br />";
